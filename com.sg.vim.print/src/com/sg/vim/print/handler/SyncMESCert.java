...
public class SyncMESCert extends AbstractHandler {
	...
	private static final Object MES_VEH_HXNBC = "VEH_HXNBC";
	private static final Object MES_VEH_HXNBK = "VEH_HXNBK";
	private static final Object MES_VEH_HXNBG = "VEH_HXNBG";
	private static final Object MES_VEH_EDZZL = "VEH_EDZZL";
	private static final Object MES_VEH_ZZLLYXS = "VEH_ZZLLYXS";
	private static final Object MES_VEH_ZQYZZL = "VEH_ZQYZZL";
	private static final Object MES_VEH_BGCAZZDYXZZL = "VEH_BGCAZZDYXZZL";
	private static final Object MES_VEH_JSSZCRS = "VEH_JSSZCRS";
	private static final Object MES_VEH_CJH = "VEH_CJH";
	private static final Object MES_VEH_DPID = "VEH_DPID";
	private static final Object MES_QYID = "QYID";
	private static final Object MES_HZDCZFS = "HZDCZFS";
	private static final Object MES_HZDFS = "HZDFS";
	private static final Object MES_QZDCZFS = "QZDCZFS";
	private static final Object MES_QZDFS = "QZDFS";
	private static final Object MES_VEH_TMXX = "VEH_TMXX";
	private static final Object MES_PZXLH = "PZXLH";
	private DBCollection collection;

	public SyncMESCert() {
		super();
		collection = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_CERF);
	}
	...
	private void importMESItem(BasicDBObject ist) {
		...
		cert.put(IVIMFields.mVeh_Hxnbg, MES_VEH_HXNBG);// Veh_Hxnbg";//货厢内部高字符4
		...
		cert.put(IVIMFields.mVeh_Edzzl, MES_VEH_EDZZL);// Veh_Edzzl";//额定载质量字符8

		// VEH_ZZLLYXS VARCHAR2(32) Y 载质量利用系数
		cert.put(IVIMFields.mVeh_Zzllyxs, MES_VEH_ZZLLYXS);// Veh_Zzllyxs";//载质量利用系数字符30

		// VEH_ZQYZZL VARCHAR2(32) Y 准牵引总质量
		cert.put(IVIMFields.mVeh_Zqyzzl, MES_VEH_ZQYZZL);// Veh_Zqyzzl";//准牵引总质量字符8

		// VEH_BGCAZZDYXZZL VARCHAR2(32) Y 半挂车鞍座最大允许总质量
		cert.put(IVIMFields.mVeh_Bgcazzdyxzzl, MES_VEH_BGCAZZDYXZZL);// Veh_Bgcazzdyxzzl";//半挂车鞍座最大允许总质量字符8
		// VEH_JSSZCRS VARCHAR2(32) Y 驾驶室准载人数
		cert.put(IVIMFields.mVeh_Jsszcrs, MES_VEH_JSSZCRS);// Veh_Jsszcrs";//驾驶室准乘人数字符3
		...
		// NOTICE_CODE VARCHAR2(100) Y 公告型号
		...
		cert.put(IVIMFields.mVeh_Cjh, MES_VEH_CJH);// Veh_Cjh";//车架号字符25
		// VEH_DPID VARCHAR2(20) Y 底盘ID
		cert.put(IVIMFields.mVeh_Dpid, MES_VEH_DPID);// Veh_Dpid";//底盘ID字符7
		...
		cert.put(IVIMFields.mVeh_Qyid, MES_QYID);// Veh_Qyid";//企业ID字符88位公告企业ID
		// ZZBH VARCHAR2(50) Y 纸张编号
		cert.put(IVIMFields.mVeh_Zzbh, ist.get(MES_ZZBH));// Veh_Zzbh";
		// HZDCZFS VARCHAR2(50) Y 后制动操作方式
		cert.put(IVIMFields.mVeh__Hzdczfs, MES_HZDCZFS);// Veh_Hzdczfs";
		// HZDFS VARCHAR2(50) Y 后制动方式
		cert.put(IVIMFields.mVeh__Hzdfs, MES_HZDFS);// Veh_Hzdfs";
		// QZDCZFS VARCHAR2(50) Y 前制动操作方式
		cert.put(IVIMFields.mVeh__Qzdczfs, MES_QZDCZFS);// Veh_Qzdczfs";
		// QZDFS VARCHAR2(50) Y 前制动方式
		cert.put(IVIMFields.mVeh__Qzdfs, MES_QZDFS);// Veh_Qzdfs";
		...
		cert.put(IVIMFields.mVeh_Tmxx, MES_VEH_TMXX);// Veh_Tmxx";//合格证条码信息字符1000
		...
		cert.put(IVIMFields.mVeh__Pzxlh, MES_PZXLH);// Veh_Pzxlh";
