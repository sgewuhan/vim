...
public class CertificateRequestService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(com.sg.vim.datamodel.service.vidc.CertificateRequestService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.sg.vim.datamodel.service.vidc.CertificateRequestService.class
                    .getResource(".");
