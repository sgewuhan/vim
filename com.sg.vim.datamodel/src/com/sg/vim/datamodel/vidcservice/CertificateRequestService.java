...
public class CertificateRequestService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(com.sg.vim.datamodel.vidcservice.CertificateRequestService.class
					.getName());
	...
	static {
		...
		try {
			...
			baseUrl = com.sg.vim.datamodel.vidcservice.CertificateRequestService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://"+VimUtils.LOCAL_CERT_ARRESS+"/CertificateRequestService.asmx?WSDL");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://"+VimUtils.LOCAL_CERT_ARRESS+"/CertificateRequestService.asmx?WSDL', retrying as a local file");
	...
	public CertificateRequestService() {
		super(CERTIFICATEREQUESTSERVICE_WSDL_LOCATION, new QName(
				"http://service.vidc.info/certificaterequest",
	...
	public CertificateRequestServiceSoap getCertificateRequestServiceSoap() {
		return super.getPort(new QName(
				"http://service.vidc.info/certificaterequest",
				"CertificateRequestServiceSoap"),
				CertificateRequestServiceSoap.class);
	}
	...
	public CertificateRequestServiceSoap getCertificateRequestServiceSoap12() {
		return super.getPort(new QName(
				"http://service.vidc.info/certificaterequest",
				"CertificateRequestServiceSoap12"),
				CertificateRequestServiceSoap.class);
	}
