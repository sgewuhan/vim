	...
	static {
		...
		try {
			...
			baseUrl = com.sg.vim.datamodel.vidcservice.CertificateRequestService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://"+VimUtils.LOCAL_SERVER+"/CertificateRequestService.asmx?WSDL");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://"+VimUtils.LOCAL_SERVER+"/CertificateRequestService.asmx?WSDL', retrying as a local file");
