...
public class VimUtils {
	 ...
	 */
	public static final String[] paraSeq = new String[] {
			IVIMFields.mVeh_Clztxx, IVIMFields.mVeh_Zchgzbh,
			IVIMFields.mVeh_Dphgzbh, IVIMFields.mVeh_Fzrq,
			IVIMFields.mVeh_Clzzqymc, IVIMFields.mVeh_Qyid,
			IVIMFields.mVeh_Clfl, IVIMFields.mVeh_Clmc, IVIMFields.mVeh_Clpp,
			IVIMFields.mVeh_Clxh, IVIMFields.mVeh_Csys, IVIMFields.mVeh_Dpxh,
			IVIMFields.mVeh_Dpid, IVIMFields.mVeh_Clsbdh, IVIMFields.mVeh_Cjh,
			IVIMFields.mVeh_Fdjh, IVIMFields.mVeh_Fdjxh, IVIMFields.mVeh_Rlzl,
			IVIMFields.mVeh_Pfbz, IVIMFields.mVeh_Pl, IVIMFields.mVeh_Gl,
			IVIMFields.mVeh_Zxxs, IVIMFields.mVeh_Qlj, IVIMFields.mVeh_Hlj,
			IVIMFields.mVeh_Lts, IVIMFields.mVeh_Ltgg, IVIMFields.mVeh_Gbthps,
			IVIMFields.mVeh_Zj, IVIMFields.mVeh_Zh, IVIMFields.mVeh_Zs,
			IVIMFields.mVeh_Wkc, IVIMFields.mVeh_Wkk, IVIMFields.mVeh_Wkg,
			IVIMFields.mVeh_Hxnbc, IVIMFields.mVeh_Hxnbk,
			IVIMFields.mVeh_Hxnbg, IVIMFields.mVeh_Zzl, IVIMFields.mVeh_Edzzl,
			IVIMFields.mVeh_Zbzl, IVIMFields.mVeh_Zzllyxs,
			IVIMFields.mVeh_Zqyzzl, IVIMFields.mVeh_Edzk,
			IVIMFields.mVeh_Bgcazzdyxzzl, IVIMFields.mVeh_Jsszcrs,
			IVIMFields.mVeh_Zgcs, IVIMFields.mVeh_Clzzrq, IVIMFields.mVeh_Bz,
			IVIMFields.mVeh_Qybz, IVIMFields.mVeh_Clscdwmc,
			IVIMFields.mVeh_Cpscdz, IVIMFields.mVeh_Qyqtxx,
			IVIMFields.mVeh_Zxzs, IVIMFields.mVeh_Yh, IVIMFields.mVeh_Cpggh,
			IVIMFields.mVeh_Ggpc, IVIMFields.mVeh_Ggsxrq,
			IVIMFields.mVeh_PrinterName, IVIMFields.mVeh_PrintPosLeft,
			IVIMFields.mVeh_PrintPosTop, IVIMFields.mVeh_Connect,
			IVIMFields.mVeh_Baud, IVIMFields.mVeh_Parity,
			IVIMFields.mVeh_Databits, IVIMFields.mVeh_Stopbits,
	...
	/**
	 * 查询数据库字段名 意思 vin VIN erp_product_code 成品码 safety_components_vin 发动机号
	 * manufacture_date 制造日期 是否需要打印合格证 此字段暂无，待ERP确定后增加
	 * 
	 * @param vin
	 * @return
	 * @throws Exception
	...
	public static DBObject getProductCodeInfo(String productCode)
		...
		DBObject query = new BasicDBObject().append(IVIMFields.E_02,
				productCode);
	...
	public static DBObject getCOCInfo(DBObject productCodeData)
			throws Exception {
		DBCollection c = DBActivator.getCollection(IVIMFields.DB_NAME,
	...
	public static DataObjectEditorInput getCerfInput(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
			IEditorSaveHandler saveHandler, String vin, boolean isDP)
			throws Exception {
		DataEditorConfigurator conf = (DataEditorConfigurator) UI
				.getEditorRegistry().getConfigurator(
						isDP ? DPCERT_EDITOR : QXCERT_EDITOR);
		DBCollection c = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_CERF);
		DBObject dbObject = transferCerfData(cocData, confData,
				productCodeData, mesRawData, vin, isDP);
		DataObject data = new DataObject(c, dbObject);
		DataObjectEditorInput editorInput = new DataObjectEditorInput(data,
				conf, saveHandler);
		if (debug) {
	...
	public static DataObjectEditorInput getCOCInput(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
			IEditorSaveHandler saveHandler, String vin) {
		DataEditorConfigurator conf = (DataEditorConfigurator) UI
				.getEditorRegistry().getConfigurator(COCPAPER_EDITOR);
		DBCollection c = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_COCPAPER);
		DBObject dbObject = transferCOCData(cocData, confData, productCodeData,
				mesRawData, vin);
		DataObject data = new DataObject(c, dbObject);
		DataObjectEditorInput editorInput = new DataObjectEditorInput(data,
				conf, saveHandler);
	...
	public static DataObjectEditorInput getFLInput(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
			IEditorSaveHandler saveHandler, String vin) {
		DataEditorConfigurator conf = (DataEditorConfigurator) UI
				.getEditorRegistry().getConfigurator(FUELLABEL_EDITOR);
		DBCollection c = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_FUELABEL);
		DBObject dbObject = transferFuelLabelData(cocData, confData,
				productCodeData, mesRawData, vin);
		DataObject data = new DataObject(c, dbObject);
		DataObjectEditorInput editorInput = new DataObjectEditorInput(data,
				conf, saveHandler);
		if (debug) {
	...
	private static DBObject transferFuelLabelData(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
			String vin) {
	...
	private static DBObject transferCOCData(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
			String vin) {
		BasicDBObject result = new BasicDBObject();
	...
	public static DBObject transferCerfData(DBObject cocData,
			DBObject confData, DBObject productCodeData, SQLRow mesRawData,
...
//		}
	...
	public static void uploadCert(List<DBObject> certList) throws Exception {
		CertificateRequestServiceSoap vidService = DataModelActivator
				.getVIDCService();
		ArrayOfCertificateInfo cis = new ArrayOfCertificateInfo();

		for (int i = 0; i < certList.size(); i++) {
			CertificateInfo certificateInfo = getCertificateInfo(certList
					.get(i));
	...
	public static void uploadCert2(List<DBObject> certList, String memo)
			throws Exception {
		CertificateRequestServiceSoap vidService = DataModelActivator
				.getVIDCService();
		ArrayOfCertificateInfo cis = new ArrayOfCertificateInfo();
	...
	public static void updateCert(List<DBObject> certList, String memo)
			throws Exception {
		CertificateRequestServiceSoap vidService = DataModelActivator
				.getVIDCService();
		ArrayOfCertificateInfo cis = new ArrayOfCertificateInfo();
	...
	private static CertificateInfo getCertificateInfo(DBObject data)
			throws Exception {
	...
	private static CertificateInfo getCertificateInfo(DBObject data,
		...
		// 上传主机硬件信息
		// s:string
		Assert.isNotNull(HARDWAREID,
				"HARDWAREID不可为空，请检查vim.properties文件是否设置了属性vidc.hardware");
		...
		// s:string
		//
		Assert.isNotNull(HD_USER,
				"HD_USER不可为空，请检查vim.properties文件是否设置了属性vidc.user");
	...
	public static String getLifecycle(String vin, String collectionName) {
		DBCollection col = DBActivator.getCollection("appportal",
				collectionName);
		DBObject d = col.findOne(
				new BasicDBObject().append(IVIMFields.mVeh_Clsbdh, vin),
	...
	public static DBObject getCertDataByVin(String vin, String clztxx) {
		DBCollection col = DBActivator.getCollection("appportal",
				IVIMFields.COL_CERF);
		return col.findOne(new BasicDBObject().append(IVIMFields.mVeh_Clsbdh,
				vin).append(IVIMFields.mVeh_Clztxx, clztxx));
	}
	...
	public static HashMap<String, String> getPrinterParameters(
		...
		DBObject data = col.findOne(new BasicDBObject().append(
				IVIMFields.mVeh_A_PrinterFunction, printfunctionName));
		if (data != null) {
			HashMap<String, String> result = new HashMap<String, String>();
			result.put(IVIMFields.mVeh_PrinterName,
					(String) data.get(IVIMFields.mVeh_PrinterName));
			result.put(IVIMFields.mVeh_PrintPosLeft,
					(String) data.get(IVIMFields.mVeh_PrintPosLeft));
			result.put(IVIMFields.mVeh_PrintPosTop,
					(String) data.get(IVIMFields.mVeh_PrintPosTop));
			result.put(IVIMFields.mVeh_Connect,
					(String) data.get(IVIMFields.mVeh_Connect));
			result.put(IVIMFields.mVeh_Baud,
					(String) data.get(IVIMFields.mVeh_Baud));
			result.put(IVIMFields.mVeh_Parity,
					(String) data.get(IVIMFields.mVeh_Parity));
			result.put(IVIMFields.mVeh_Databits,
					(String) data.get(IVIMFields.mVeh_Databits));
			result.put(IVIMFields.mVeh_Stopbits,
					(String) data.get(IVIMFields.mVeh_Stopbits));
			return result;
		}
		return null;
	}
	...
	public static void saveRePrintData(DBObject data, DBObject info) {
		...
		BasicDBObject rec = new BasicDBObject()
				...
				.append(IVIMFields.ACTION_REC_ACCOUNT, accountInfo)
				.append(IVIMFields.ACTION_REC_TYPE,
						IVIMFields.ACTION_REC_TYPE_VALUE_REPRINT)
				.append(IVIMFields.ACTION_REC_MEMO,
						"No.:" + data.get(IVIMFields.mVeh_Zzbh));
	...
	public static DBObject saveCancelData(List<ObjectId> idList, String memo) {
		...
		BasicDBObject rec = new BasicDBObject()
				...
				.append(IVIMFields.ACTION_REC_ACCOUNT, accountInfo)
				.append(IVIMFields.ACTION_REC_TYPE,
						IVIMFields.ACTION_REC_TYPE_VALUE_CANCEL)
				.append(IVIMFields.ACTION_REC_MEMO, memo);
		...
		DBObject query = new BasicDBObject().append("_id",
				new BasicDBObject().append("$in", idList));
		DBObject setting = new BasicDBObject()
				.append(IVIMFields.CANCELACCOUNT, accountInfo)
	...
	public static DBObject saveUpdateData(ObjectId id, String memo) {
		...
		BasicDBObject rec = new BasicDBObject()
				...
				.append(IVIMFields.ACTION_REC_ACCOUNT, accountInfo)
				.append(IVIMFields.ACTION_REC_TYPE,
						IVIMFields.ACTION_REC_TYPE_VALUE_UPDATE)
				.append(IVIMFields.ACTION_REC_MEMO, memo);

		DBCollection col = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_CERF);
		DBObject query = new BasicDBObject().append("_id", id);
		DBObject setting = new BasicDBObject().append(IVIMFields.UPDATEACCOUNT,
				accountInfo).append(IVIMFields.UPDATEDATE, date);
		BasicDBObject update = new BasicDBObject().append("$set", setting)
				.append("$push",
						new BasicDBObject().append(IVIMFields.ACTION_REC, rec));
	...
	public static DBObject saveRemoveData(List<ObjectId> idList, String memo,
		...
		BasicDBObject rec = new BasicDBObject()
				...
				.append(IVIMFields.ACTION_REC_ACCOUNT, accountInfo)
				.append(IVIMFields.ACTION_REC_TYPE,
						IVIMFields.ACTION_REC_TYPE_VALUE_ABANDON)
				.append(IVIMFields.ACTION_REC_MEMO, memo);
		...
		DBObject query = new BasicDBObject().append("_id",
				new BasicDBObject().append("$in", idList));
		DBObject setting = new BasicDBObject()
				.append(IVIMFields.ABANDONACCOUNT, accountInfo)
	...
	public static void saveCOCPrintData(DBObject data) throws Exception {
		...
		BasicDBObject rec = new BasicDBObject()
				...
				.append(IVIMFields.ACTION_REC_ACCOUNT, accountInfo)
				.append(IVIMFields.ACTION_REC_TYPE,
						IVIMFields.ACTION_REC_TYPE_VALUE_PRINT)
				.append(IVIMFields.ACTION_REC_MEMO, "");

		DBCollection col = DBActivator.getCollection(IVIMFields.DB_NAME,
				IVIMFields.COL_COCPAPER);
		DBObject query = new BasicDBObject().append(IVIMFields.F_0_6b,
				data.get(IVIMFields.F_0_6b));

		DBObject dataItem = col.findOne(
				query,
				new BasicDBObject().append("_id", 1).append(
						IVIMFields.LIFECYCLE, 1));

		if (dataItem != null) {
			if (!IVIMFields.LC_ABANDON.equals(dataItem
					.get(IVIMFields.LIFECYCLE))) {
		...
		ObjectId oid;
		if (dataItem == null
				|| IVIMFields.LC_ABANDON.equals(dataItem
						.get(IVIMFields.LIFECYCLE))) {// 没有此VIM的COC证书或者COC证书已经作废
			oid = new ObjectId();
			data.put("_id", oid);
	...
	public static void printFuelLabel(Browser browser, DBObject dbObject)
			throws Exception {
	...
	public static void printCOC(Browser browser, DBObject dbObject)
			throws Exception {
