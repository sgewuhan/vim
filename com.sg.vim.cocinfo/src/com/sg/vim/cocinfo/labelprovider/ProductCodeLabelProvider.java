...
//        Object cfginfo_name = data.get(IVIMFields.CFG_NAME);
        ...
        String tag1 = cocinfo_id == null ? "Œ¥÷∏∂®    " : "¥Úø™    ";
        String tag2 = cfginfo_id == null ? "Œ¥÷∏∂®    " : "¥Úø™    ";
        ...
        builder.append("<span style='float:left;padding:0px 4px 4px 4px;FONT-FAMILY:Œ¢»Ì—≈∫⁄;font-size:11pt'><b>");
