...
class ConnectionManager {
    ...
    while (propNames.hasMoreElements()) {
      ...
      if (name.endsWith(".url")) {
        ...
        try {
          ...
          System.out.println("ERROR SETTING OF: MAX CONNECTION COUNT" + maxconn + " .POOL NAME: "
              + poolName);
          max = 10;
        }
  ...
  private void init() {
    try {
      InputStream is = new BufferedInputStream(new FileInputStream(System.getProperty("user.dir")
          + "/conf/db.properties"));
