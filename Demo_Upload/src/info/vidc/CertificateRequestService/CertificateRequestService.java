...
public class CertificateRequestService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(info.vidc.CertificateRequestService.CertificateRequestService.class
					.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = info.vidc.CertificateRequestService.CertificateRequestService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://localhost:9901/CertificateRequestService.asmx?WSDL");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://localhost:9901/CertificateRequestService.asmx?WSDL', retrying as a local file");
